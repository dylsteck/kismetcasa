  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col float-left gap-6">
        <p>
          <span className="text-xl font-medium">Kismet</span> was founded in
          2018 by Luciano DeAngelo to unite like-minded individuals during the
          challenging times of the bear market. We partner with value-aligned
          organizations to subsidize housing and travel costs for our hackers.
          Lea Olmos joined Kismet in 2020 after being introduced to Luciano
          through a mutual friend. Lea has played an integral role in creating
          and maintaining Kismet Casa by spearheading our operations.
        </p>

        <div className="flex flex-col gap-2">
          <p className="text-xl font-medium pb-1">Events</p>
        ...
        <div className="flex flex-col gap-2">
          <div>
            <p className="text-xl font-medium pb-1">NFTs</p>
        ...
        <div className="flex flex-col gap-2 pb-[2.5vh]">
          <div>
            <p className="text-xl font-medium pb-1">Contact</p>
            <p>
              Twitter -{' '}
              <span className="font-light text-sm">
                <Link href="https://twitter.com/kismetcasa">@kismetcasa</Link>
              </span>
            </p>
            <p>
              Onchain -{' '}
              <span className="font-light text-sm">
                <Link href="https://rainbow.me/kismetcasa.eth">
                  kismetcasa.eth
                </Link>
              </span>
            </p>
            <p>
              Luciano -{' '}
              <span className="font-light text-sm">
                <Link href="https://twitter.com/lucianodeangelo">
                  @lucianodeangelo
                </Link>
              </span>
            </p>
            <p>
              Lea -{' '}
              <span className="font-light text-sm">
                <Link href="https://twitter.com/leaolmos">@leaolmos</Link>
              </span>
            </p>
          </div>
        </div>
